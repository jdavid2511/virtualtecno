...
class menu_VI
{
    ...
    {   
     ...
     foreach ($arreglo as $documento) {
        $usuario = $documento['first_name'];
    }
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="datatables/datatables/DataTables-1.12.1/css/dataTables.bootstrap4.min.css">
    <!-- Bootstrap -->
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.php" class="site_title"><i class="fa fa-usd "></i> <span>VIRTUAL TECNO
                            </span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa-solid fa-shop"></i> INVENTARIO<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">

                                        <li class="nav-item"><a href="#"
                                                onclick="verModulo('producto_VI/agregarProducto');">productos</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa-solid fa-pen"></i> ENTRADAS<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li class="nav-item"><a href="#"
